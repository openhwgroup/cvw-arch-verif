...
Instructions introduced by Hypervisor extension.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/H.csv[]
,===

==== ZicsrH

CSRs introduced by Hypervisor extension.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/ZicsrH.csv[]
,===

==== ZicsrHF

Floating-point CSR behavior introduced by Hypervisor extension.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/ZicsrHF.csv[]
,===

==== ZicsrHV

Vector CSR behavior introduced by Hypervisor extension.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/ZicsrHV.csv[]
,===

==== ExceptionsH

Exceptions introduced by Hypervisor extension.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/ExceptionsH.csv[]
,===

==== ExceptionsHV

Vector exceptions introduced by Hypervisor extension.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/ExceptionsHV.csv[]
,===

==== InterruptsH

Interrupts introduced by Hypervisor extension.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/InterruptsH.csv[]
,===

==== EndianH

Endianness introduced by Hypervisor extension.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/EndianH.csv[]
,===

==== ZicntrH

Counter behavior introduced by Hypervisor extension.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/ZicntrH.csv[]
,===

==== ZihpmH

Hardware performance monitor behavior introduced by Hypervisor extension.

[[t-ZihpmH-coverpoints]]
.ZihpmH Coverpoints
[options=header]
[%AUTOWIDTH]
,===
include::{testplansdir}/ZihpmH.csv[]
,===

==== PMPH

PMP behavior introduced by Hypervisor extension.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/RV32VMH.csv[]
,===
...
[%AUTOWIDTH]
,===
include::{testplansdir}/RV32VMH_CBO.csv[]
,===
...
[%AUTOWIDTH]
,===
include::{testplansdir}/RV64VMH.csv[]
,===
...
[%AUTOWIDTH]
,===
include::{testplansdir}/RV64VMH_CBO.csv[]
,===

==== SsstrictH

Strict behavior introduced by Hypervisor extension.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/SsstrictH.csv[]
,===

==== Shcounterenw

Writable counter enables.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/Shcounterenw.csv[]
,===
...
[%AUTOWIDTH]
,===
include::{testplansdir}/Shvsatpa.csv[]
,===
...
[%AUTOWIDTH]
,===
include::{testplansdir}/Shgatpa.csv[]
,===

==== Shvstvecd

VS-mode direct vector.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/Shvstvecd.csv[]
,===

==== Shvstvala

VS-mode stval address.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/Shvstvala.csv[]
,===

==== Shtvala

HS-mode htval address.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/Shtvala.csv[]
,===

==== Shlcofideleg

Hypervisor counter overflow delegation.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/Shlcofideleg.csv[]
,===

==== ZkrH

Hypervisor entropy register.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/ZkrH.csv[]
,===

==== SstcH

Hypervisor timer compare.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/SstcH.csv[]
,===
...
[%AUTOWIDTH]
,===
include::{testplansdir}/SsstateenH.csv[]
,===
...
[%AUTOWIDTH]
,===
include::{testplansdir}/SscrindH.csv[]
,===
...
[%AUTOWIDTH]
,===
include::{testplansdir}/SscfgH.csv[]
,===
...
[%AUTOWIDTH]
,===
include::{testplansdir}/SmctrH.csv[]
,===

==== SvinvalH

Hypervisor memory management table invalidation.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/SvinvalH.csv[]
,===

==== SvaduH

Hypervisor hardware page table A/D updates.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/SvaduH.csv[]
,===

==== ZicfilpH

Hypervisor landing pads.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/ZicfilpH.csv[]
,===
...
[%AUTOWIDTH]
,===
include::{testplansdir}/ZicfissH.csv[]
,===
...
[%AUTOWIDTH]
,===
include::{testplansdir}/SsdbltrpH.csv[]
,===
...
[%AUTOWIDTH]
,===
include::{testplansdir}/SsnpmH.csv[]
,===
...
[%AUTOWIDTH]
,===
include::{testplansdir}/SmnpmH.csv[]
,===

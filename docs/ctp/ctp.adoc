...
|cp_fs1_corners_v|22|±0, ±1, ±smallest normal, ±largest normal, ±inf, 0.5, 1.5, 2, 4, pi, 2^emax, 1+ulp, largest subnormal, subnormal with leading 1 in fraction, canonical quite NaN, noncanonical quiet NaN, signaling NaN with payload of 1
|cp_vs2_corners|9 or 22|see cp_rs1_corners or cp_fs1_corners_v
|cp_vs1_corners|9 or 22|see cp_rs1_corners
|cr_vs2_vs1_corners|9^2 or 22^2|Cross-product of corners of vs2 and vs1
|cr_vs2_rs1_corners|9*9|Cross-product of corners of vs2 and rs1
|cr_vs2_fs1_corners|22*22|Cross-product of corners of vs2 and fs1

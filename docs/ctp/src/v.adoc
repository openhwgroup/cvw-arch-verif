...
==== Zvfhmin Half-Precision Load Immediate

Zvfhmin only exercises the widening and narrowing conversions: `vfwcvt.f.f.v` and `vfncvt.f.f.w`.

[[t-Zfvhmin-coverpoints]]
.Zffvhmin Instruction Coverpoints
[options=header]
[%AUTOWIDTH]
,===
include::{testplansdir}/Zvfhmin.csv[]
,===
...
[%AUTOWIDTH]
,===
include::{testplansdir}/ZfaZvfh.csv[]
,===
...
[%AUTOWIDTH]
,===
// include::{testplansdir}/Zvkned.csv[]
,===
...
[%AUTOWIDTH]
,===
// include::{testplansdir}/Zvknh.csv[]
,===

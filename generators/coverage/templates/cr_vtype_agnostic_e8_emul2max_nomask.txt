//////////////////////////////////////////////////////////////////////////////////
    // cr_vtype_agnostic_e8_emul2max_nomask
    //////////////////////////////////////////////////////////////////////////////////
    ...
    cr_vtype_agnostic_e8_emul2max_nomask : cross cp_csr_vtype_vta,cp_csr_vtype_vma,not_maskable iff (ins.trap == 0 )  {
        // Cross coverage of vector tail and mask agnostic behaviors
    }

    //// end cr_vtype_agnostic_e8_emul2max_nomask////////////////////////////////////////////////

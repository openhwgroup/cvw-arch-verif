...
<<t-C-priv-normative-statements>> summarizes normative statements relating to compressed instructions affecting privileged behavior.
...
[%AUTOWIDTH]
,===
include::{testplansdir}/ZcbZba.csv[]
,===
...
[%AUTOWIDTH]
,===
include::{testplansdir}/ZcbZbb.csv[]
,===

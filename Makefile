...
sim:
	...
	wsim rv64gc ${WALLY}/addins/cvw-arch-verif/tests/rv64/F/WALLY-COV-flw.elf --fcov
	wsim rv32gc ${WALLY}/addins/cvw-arch-verif/tests/rv32/F/WALLY-COV-flw.elf --fcov

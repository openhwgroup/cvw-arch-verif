...
* Parameters: options describing the behavior of extensions.  Parameters may or may not have an official RISC-V name.  For example, the M extension defines
...
* Bin: One target value for a coverpoint.

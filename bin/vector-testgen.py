...
def make_vd_vs1_vs2(test, sew, rng):
  global basetest_count
  for v in rng:
    [vs1, vs2, rs1, vd, rd, vs1val, vs2val, rs1val, immval, vdval] = randomizeVectorV(test)

...
The A extension is subdivided into Zaamo and Zalrsc.
 <<t-A-normative-statements>> lists the normative rules in the RV{32/64}A specification applicable to all instructions, and the unprivileged coverpoints that exercise them.
...
<<t-A-priv-normative-statements>> summarizes normative rules relating to atomic instructions affecting privileged behavior.

...
#wsim rv64gc $(TESTDIR)/lockstep/rv64/I/WALLY-COV-ALL-1.elf --fcov --lockstepverbose --define "+define+FCOV_VERBOSE"  > verbosem.log
	wsim rv32gc $(TESTDIR)/lockstep/rv32/I/WALLY-COV-sw.elf --fcov --lockstepverbose --define "+define+FCOV_VERBOSE"  > verbosem.log
	$(MAKE) merge

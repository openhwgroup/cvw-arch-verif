  ...
  for xlen in xlens:
    for extension in ["I", "M", "F", "Zicond","Zca"]:
      ...
      if (xlen == 32):
        ...
        # TODO: NaN-boxes all of the corners for RV64F
        #       these will probably have to be different for the D, Q extensions
        fcorners64 = [0xffffffff00000000 | corner for corner in fcorners]
        fcorners = fcorners64

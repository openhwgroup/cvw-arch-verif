...
if __name__ == '__main__':
  ...
  corners_imm_12bit = [0, 1, 2, 3, 4, 5, 6, 8, 16, 32, 44, 45, 46, 62, 63, 64, 128, 256, 512, 818, 819, 820, 1023, 1024, 1364, 1365, 1366, 1637, 1638, 1639, 1795, 2047, -2048, -2047, -1367, -1366, -1365, -45, -44, -2, -1]
...
#      for E_ext in [False, True]:
      for E_ext in [False]: # for testing only ***
        ...
        #for extension in ["I"]:  # temporary for faster run
          ...
          corners = [0, 1, 2, 3, 4, 5, 6, 2**(xlen-1), 2**(xlen-1)+1, 2**(xlen-1)-1, 2**(xlen-1)-2, 2**xlen-1, 2**xlen-2]
          if (xlen == 32):
            corners = corners + [0b01011011101111001000100001110010, # random
                                 0b10101010101010101010101010101010, # walking odd
                                 0b10101010101010101010101010101001, # walkoddm1
                                 0b10101010101010101010101010101011, # walkoddp1
                                 0b01010101010101010101010101010101, # walking even
                                 0b01010101010101010101010101010100, # walkevenm1
                                 0b01010101010101010101010101010110, # walkevenp1
                                 0b00000000000000001111111111111111, # Hmax
                                 0b00000000000000001111111111111110, # Hmaxm1
                                 0b00000000000000010000000000000000, # Hmaxp1
                                 0b00000000000000001011010100000101, # Hval1
                                 0b00000000000000001011010100000011, # Hval2
                                 0b00000000000000001011010100000100, # Hval3
                                 0b11111111111111110100101011111100, # Hsign1
                                 0b11111111111111110100101011111101, # Hsign2
                                 0b00110011001100110011001100110011, # pairs0
                                 0b00110011001100110011001100110100, # pairs0p1
                                 0b00110011001100110011001100110010, # pairs0m1
                                 0b01100110011001100110011001100110, # pairs1
                                 0b01100110011001100110011001100111, # pairs1p1
                                 0b01100110011001100110011001100101, # pairs1m1
                                 0b11001100110011001100110011001100, # pairs2
                                 0b11001100110011001100110011001101, # pairs2p1
                                 0b11001100110011001100110011001011, # pairs2m1
                                 0b10011001100110011001100110011001, # pairs3
                                 0b10011001100110011001100110011010, # pairs3p1
                                 0b10011001100110011001100110011000] # pairs3m1
          else:
            corners = corners + [0b0101101110111100100010000111011101100011101011101000011011110010, # random
                                ...
                                0b1010101010101010101010101010101010101010101010101010101010101001, # walkoddm1
                                0b1010101010101010101010101010101010101010101010101010101010101011, # walkoddp1
                                0b0101010101010101010101010101010101010101010101010101010101010101, # walking even
                                0b0101010101010101010101010101010101010101010101010101010101010100, # walkevenm1
                                0b0101010101010101010101010101010101010101010101010101010101010110, # walkevenp1
                                0b0000000000000000000000000000000011111111111111111111111111111111, # Wmax
                                0b0011001100110011001100110011001100110011001100110011001100110011, # pairs0
                                0b0011001100110011001100110011001100110011001100110011001100110100, # pairs0p1
                                0b0011001100110011001100110011001100110011001100110011001100110010, # pairs0m1
                                0b0110011001100110011001100110011001100110011001100110011001100110, # pairs1
                                0b0110011001100110011001100110011001100110011001100110011001100111, # pairs1p1
                                0b0110011001100110011001100110011001100110011001100110011001100101, # pairs1m1
                                0b1100110011001100110011001100110011001100110011001100110011001100, # pairs2
                                0b1100110011001100110011001100110011001100110011001100110011001101, # pairs2p1
                                0b1100110011001100110011001100110011001100110011001100110011001011, # pairs2m1
                                0b1001100110011001100110011001100110011001100110011001100110011001, # pairs3
                                0b1001100110011001100110011001100110011001100110011001100110011010, # pairs3p1
                                0b1001100110011001100110011001100110011001100110011001100110011000, # pairs3m1
                                ...
                                0b0000000000000000000000000000000010110101000001001111001100110011, # Wpairs0
                                0b0000000000000000000000000000000010110101000001001111001100110010, # Wpairs1
                                0b0000000000000000000000000000000010110101000001001111001100110100, # Wpairs2
                                0b1111111111111111111111111111111101001010111110110000110011001110, # Wsign1
                                0b1111111111111111111111111111111101001010111110110000110011001101] # Wsign2

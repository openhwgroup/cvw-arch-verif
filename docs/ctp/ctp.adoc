...
The C extension is subdivided into Zca, Zcf, and Zcd.  All configurations supporting C contain Zca.  RV32CF profiles also contain Zcf, and RV{32/64}CD profiles also contain Zcd.  A configuration supporting C should test all of the applicable Zc* extensions.
...
|28.4|MISA.C is set if the following extensions are selected:
* Zca and not F

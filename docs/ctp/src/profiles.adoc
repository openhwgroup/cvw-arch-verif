...
|VMPMP|VM + PMP|<<t-VMPMP-coverpoints>>|||||
|CBOVM|VM + CBO|<<t-CBOVM-coverpoints>>|||||
|CBOPMP|CBO + PMP|<<t-CBOPMP-coverpoints>>|||||
|VM_PMP|VM + PMP||Svinval|TLB Invalidation|<<t-Svinval-coverpoints>>|||x|x|x

...
|cp_fs1_corners_v|20|±0, ±1, smallest normal, -largest normal, ±inf, 0.5, 1.5, -2, pi, 2^emax, 1+ulp, largest subnormal, subnormal with leading 1 in fraction, canonical quite NaN, -noncanonical quiet NaN, signaling NaN with payload of 1

//////////////////////////////////////////////////////////////////////////////////
    // cr_vtype_agnostic_e64_emul4max_nomask
    //////////////////////////////////////////////////////////////////////////////////

    // _emul*max is an artifact of test generation necessary to specify to ensure instructs that trap aren't generated
    ...
    cr_vtype_agnostic_e64_emul4max_nomask : cross cp_csr_vtype_vta,cp_csr_vtype_vma,not_maskable iff (ins.trap == 0 )  {
        // Cross coverage of vector tail and mask agnostic behaviors
    }

    //// end cr_vtype_agnostic_e64_emul4max_nomask////////////////////////////////////////////////
